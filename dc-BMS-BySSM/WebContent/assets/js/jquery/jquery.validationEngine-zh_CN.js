			...
			$.validationEngineLanguage.allRules = {
				 ...
				 * 	},*/
				  	"queryRepeat": {
				 		...
				 		"url": "shelfSlot?method=queryShelfSlotIdRepeat",
				 		"extraData": function(){
				 			//"wareHouseId="+ $("#input-wareHouse-name-clone").val();
				 			return {"wareHouseId":$("#input-wareHouse-name-clone").val(),
				 				    "code":$("#input-code-clone").val()
				 				}
				 			}, /* 额外参数 */ 
				 		// error
				  		"alertText": "* 此编码已被使用。",
